...
const MessageBox:React.FC<MessageBoxProps> = ({data, isLast}) => {
    ...
    const container = clsx(" flex gap-3", isOwn && 'justify-end'); 
    ...
    <div className={container}>
        ...
        <div className={body}>
            ...
            <div className={message}>
                {data.image ? (
                    <Image alt='Image' height="288" width="288" src={data.image} className="object-cover cursor-pointer hover:scale-110 transition translation"/>
                ) : (
                    <div>{data.body}</div>
                )}
            </div>
