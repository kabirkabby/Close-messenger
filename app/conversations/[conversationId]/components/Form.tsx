...
const Form = () => {
    ...
    const { register, handleSubmit,setValue,formState: {errors}} = useForm<FieldValues>({ defaultValues: {messages:''}})
  ...
  return (
    <div className='py-4 px-4 bg-white border-t flex items-center gap-2 lg:gap-4 w-full'>
      ...
      <CldUploadButton options= {{maxFiles: 1}} onUpload={handleUpload} uploadPreset='zxucq751'>
